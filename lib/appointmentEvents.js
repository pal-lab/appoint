  ...
  self.checkStatus = function(rootCallback) {
    ...
    CheckStatus.getStats = function(callback) {
      ...
      var _scheduleEvent = function(cb) {
        CheckStatus.scheduleEvent = Meteor.appointmentQueries.scheduleEvent(appointmentId);
        cb();
      };
      ...
      var _invitedEvent = function(cb) {
        CheckStatus.invitedEvent = Meteor.appointmentQueries.invitedEvent(appointmentId);
        cb();
      };
      ...
      var _approved = function(cb) {
        CheckStatus.approved = Meteor.appointmentQueries.approved(appointmentId);
        cb();
      };
      cbi.add(_approved);
      ...
      var _proposedDates = function(cb) {
        CheckStatus.proposedDates = Meteor.appointmentQueries.proposedDates(appointmentId);
        cb();
      };
      ...
      var _votedProposals = function(cb) {
        CheckStatus.votedProposals = Meteor.appointmentQueries.votedProposals(appointmentId);
        cb();
      };
      ...
      var _totalAnswers = function(cb) {
        CheckStatus.totalAnswers = Meteor.appointmentQueries.totalAnswers(appointmentId);
        cb();
      };
      ...
      var _invitedUsers = function(cb) {
        CheckStatus.invitedUsers = Meteor.appointmentQueries.invitedUsers(appointmentId);
        cb();
      };
      ...
      var _notVotedProposals = function(cb) {
        CheckStatus.notVotedProposals = Meteor.appointmentQueries.notVotedProposals(appointmentId);
        cb();
      };
    ...
    CheckStatus.checkVoted = function() {
      ...
      return CheckStatus.notVotedProposals <= 0 && CheckStatus.proposedDates > 0;
    };
